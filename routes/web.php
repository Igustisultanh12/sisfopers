...
Route::middleware(['auth', 'role:admin,kordinator_matra,kordinator_angkatan'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/live-chat/sync', [\App\Http\Controllers\Chat\LiveChatController::class, 'adminSync'])->name('chat.sync');
    ...
    Route::post('/live-chat/{uuid}/call/initiate', [\App\Http\Controllers\Chat\LiveChatController::class, 'initiateCall'])->name('chat.call.initiate');
...
Route::middleware(['auth', 'role:personel,admin,kordinator_angkatan,kordinator_matra', 'under_maintenance'])->prefix('personel')->name('personel.')->group(function () {
    ...
    Route::middleware(['face_verified', 'profile_complete'])->group(function () {
        ...
        Route::get('/live-chat/active-session', [\App\Http\Controllers\Chat\LiveChatController::class, 'getActiveSession'])->name('chat.active-session');
