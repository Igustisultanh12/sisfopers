      ...
      <table class="w-full text-left border-collapse">
        ...
        <tbody class="divide-y divide-[#E2E8F0] text-sm text-slate-600">
          <tr v-for="personel in personels.data" :key="personel.id" class="hover:bg-slate-50/30 transition">
            <td class="p-4">
              <img :src="personel.photo_profile ? `/storage/${personel.photo_profile}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(personel?.full_name || 'PERS')}&background=e2e8f0&color=334155`" class="w-9 h-12 object-cover rounded-lg bg-slate-100 shadow-sm border border-[#E2E8F0]" />
            </td>
            <td class="p-4">
    ...
    <div class="md:hidden space-y-4">
      <div v-for="personel in personels.data" :key="personel.id" class="bg-white border border-[#E2E8F0] rounded-3xl p-4 shadow-xs space-y-3.5">
        <div class="flex items-start gap-3.5">
          <img :src="personel.photo_profile ? `/storage/${personel.photo_profile}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(personel?.full_name || 'PERS')}&background=e2e8f0&color=334155`" class="w-12 h-16 object-cover rounded-xl bg-slate-100 shadow-sm border border-[#E2E8F0] shrink-0" />
          ...
          <div class="pointer-events-auto w-screen max-w-xl border-l border-[#E2E8F0] bg-white shadow-2xl flex flex-col">
            ...
            <div class="p-6 border-b border-[#E2E8F0] bg-slate-50/50 flex items-center justify-between">
              <div class="flex items-center gap-3">
                <img 
                  :src="selectedPersonel.photo_profile ? `/storage/${selectedPersonel.photo_profile}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(personel?.full_name || 'PERS')}&background=e2e8f0&color=334155`" 
            ...
            <div class="flex-1 overflow-y-auto p-6 bg-slate-50/40 space-y-5">
              ...
              <div v-if="currentTab === 'profile'" class="space-y-4">
                <div class="flex gap-4 items-start bg-white p-4 border border-[#E2E8F0] rounded-xl shadow-xs">
                  <img :src="selectedPersonel.photo_profile ? `/storage/${selectedPersonel.photo_profile}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(personel?.full_name || 'PERS')}&background=e2e8f0&color=334155`" class="w-16 h-20 object-cover rounded-lg border border-[#E2E8F0] bg-slate-50" />
