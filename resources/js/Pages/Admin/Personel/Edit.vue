          ...
          <div class="pt-4 border-t border-[#E2E8F0]">
            ...
            <div class="flex items-center gap-4">
              <div class="w-12 h-16 bg-slate-100 border border-[#E2E8F0] rounded-xl overflow-hidden shrink-0 shadow-xs">
                <img :src="photoPreview || (personel.photo_profile ? `/documents/private-stream?path=${encodeURIComponent(personel.photo_profile)}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(personel?.full_name || 'PERS')}&background=e2e8f0&color=334155`)" class="w-full h-full object-cover" alt="Pasfoto Personel" />
              </div>
