    ...
    <div class="space-y-6 max-w-5xl">
      ...
      <div class="lg:hidden space-y-5">
        ...
        <div class="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-5 text-white shadow-xl flex items-center gap-4 relative overflow-hidden">
          ...
          <img :src="personel.photo_profile ? `/documents/private/${personel.photo_profile}` : '/storage/default.png'" class="w-14 h-14 object-cover rounded-2xl border-2 border-white/20 shadow-md shrink-0 z-10" />
            ...
            <div class="bg-white border border-[#E2E8F0] rounded-2xl shadow-xs overflow-hidden">
              ...
              <div class="p-6 space-y-5 text-xs">
                <div class="flex flex-col sm:flex-row gap-5 items-center sm:items-start bg-slate-50/50 p-4 border border-[#E2E8F0] rounded-xl">
                  <img :src="personel.photo_profile ? `/documents/private/${personel.photo_profile}` : '/storage/default.png'" class="w-20 h-26 object-cover rounded-xl border border-[#E2E8F0] bg-white shadow-xs" />
