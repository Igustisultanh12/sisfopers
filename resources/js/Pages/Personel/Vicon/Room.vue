    ...
    <div class="flex-1 relative flex overflow-hidden">
      ...
      <main class="flex-1 p-2 sm:p-4 overflow-y-auto flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            >
              <div class="w-16 h-16 rounded-2xl bg-blue-600/20 border border-blue-500/30 flex items-center justify-center text-xl font-black text-blue-300">
      ...
      >
        <div class="p-4 border-b border-slate-800 flex items-center justify-between">
          <div>
            <h3 class="text-xs font-bold uppercase tracking-wider text-slate-200">Obrolan Rapat Dinas</h3>
