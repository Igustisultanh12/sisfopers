      ...
      <section class="bg-white border border-[#E2E8F0] rounded-2xl p-6 shadow-sm">
        ...
        <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5 text-xs">
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <input type="file" @input="form.file_ijazah = .target.files[0]" class="text-xs text-slate-500 mt-1 file:py-1 file:px-3 file:border file:border-slate-200 file:rounded-lg file:text-xs file:bg-slate-50 file:cursor-pointer" />
          </div>
