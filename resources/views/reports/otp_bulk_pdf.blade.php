...
<html>
<head>
    <title>Laporan OTP Massal - Komponen Cadangan</title>
    <style>
...
<body>
    ...
    <div class="title-block">
        <div class="title">LAPORAN KODE OTP VERIFIKASI AKUN PERSONEL</div>
    ...
    <div class="summary-box">
        ...
        Masa berlaku OTP: <strong>72 jam sejak tanggal diterbitkan</strong>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="otp-code">{{ $p->manual_otp }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <div class="instruction-box">
        ...
        <ol>
            ...
            <li>Masukkan 6 digit Kode OTP sesuai nama Anda pada tabel di atas secara tepat.</li>
