...
<html>
<head>
    <title>Lembar OTP Reset Password - {{ $personel->full_name }}</title>
    <style>
...
<body>
    ...
    <div class="title-block">
        <div class="title">LEMBAR KODE OTP RESET PASSWORD</div>
    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td class="otp-code">{{ $personel->reset_password_otp }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <div class="instruction-box">
        ...
        <ol>
            ...
            <li>Masukkan 6 digit <strong>Kode OTP Reset Password</strong> sesuai tabel di atas.</li>
